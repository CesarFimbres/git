		...
		<section id="Footer" className="footer">
			<div className="footer-enterprise">
						...
						<g id="logo_git">
							<g id="dark">
								<g id="bars">
									...
									<path
										id="bar 2"
										d="M123.207 12.8059H0V17.278H123.207V12.8059Z"
									/>
									<path
										id="bar 3"
										d="M123.207 19.5139H0V23.9859H123.207V19.5139Z"
									/>
									<path
										id="bar 4"
										d="M123.207 26.5984H0V43.0633H123.207V26.5984Z"
									/>
									<path
										id="bar 5"
										d="M123.207 44.6693H0V60.9311H123.207V44.6693Z"
									/>
									<path id="bar 6" d="M123.207 62.74H0V79.0018H123.207V62.74Z" />
									<path
										id="bar 7"
										d="M123.207 81.0226H0V85.6978H123.207V81.0226Z"
									/>
									<path
										id="bar 8"
										d="M123.207 88.5359H0V93.2111H123.207V88.5359Z"
									/>
									<path
										id="bar 9"
										d="M123.207 95.6398H0V104.584H123.207V95.6398Z"
									/>
									<path
										id="bar 10"
										d="M123.207 107.814H0V113.912H123.207V107.814Z"
									/>
									<path
										id="bar 11"
										d="M123.207 115.945H0V119.604H123.207V115.945Z"
									/>
									<path
										id="bar 12"
										d="M123.207 121.433H0V125.092H123.207V121.433Z"
									/>
								</g>
							</g>
							<g id="white">
				...
				<p className="footer-message">
					A nuestros socios comerciales, clientes y amigos les agradecemos por permanecer
					juntos en épocas difíciles, esto nos hace más fuertes, nos consolida como un
					grupo de cara al futuro, tomando conciencia de los tiempos.
				</p>

				<div className="footer-social_networks">
					<a
						href="https://api.whatsapp.com/send/?phone=5215546371510&amp;text=Hola, he visto tu página!, me gustaría recibir más información"
						target="_blank"
